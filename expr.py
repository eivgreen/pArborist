...
if __name__ == '__main__':
    with open("current_output/output_expr_detailed.txt", "w") as text_file:
        text_file.write("______________________________________________________\n")
        
    with open("current_output/output_expr.txt", "w") as text_file:
        text_file.write("______________________________________________________\n")
    ...
    for num_s in range(min_n, n):
        ...
        for counter_parts in range(num):
            ...
            with open("current_output/output_expr.txt", "a") as text_file:
                text_file.write("______________________________________________________\n")
                if counter_parts == 0 and mode == 0:
            ...
            with open("current_output/output_expr_detailed.txt", "a") as text_file:
                text_file.write("______________________________________________________\n")
                if counter_parts == 0 and mode == 0:
                    text_file.write("Warm-up ... Start!\n")
                if num == 1:
            ...
            if new_num_derived_pairs != 0 or counter_parts == num - 1:
                ...
                output.to_csv('current_output/output_expr_csv.csv', index = False)
